      ...
      <div className='container w-full mx-auto px-6 lg:px-12 text-center md:text-left'>
        <div className='flex flex-col md:flex-row items-center md:items-start'>
          ...
          <div className='w-full md:w-3/4 lg:w-2/3 space-y-6 mb-10 md:mb-0'>
            ...
            <p className='text-gray-300 text-md leading-relaxed'>
              I have a deep passion for programming and continuously learning new things along the
              way.
              <br />
              <br />I am fluent in languages such as
              <i>
                <b className='text-purple-500'> React JS, JavaScript, and Python </b>
              </i>
              ...
              <br />
              <br />I enjoy working with <b className='text-purple-500'>Node.js</b> and
              <i>
                <b className='text-purple-500'> Modern JavaScript Libraries and Frameworks</b>
              </i>{' '}
              such as{' '}
              <i>
        ...
        <div className='mt-10 text-center  w-full'>
          ...
          <p className='text-gray-300 mb-6'>
            Let's <span className='text-purple-500'> connect</span> and collaborate!
          </p>
