...
function Projects() {
  ...
  // Updated filtering logic - now shows projects that match ANY selected skill (OR condition)
  const filteredProjects =
    filteredSkills.length === 0
      ? projects
      : projects.filter((project) =>
          project.technologies.some((tech) => filteredSkills.includes(tech))
        );
      ...
      <div className='container mx-auto px-4'>
        ...
        {filteredProjects.length === 0 ? (
          <p className='text-white text-center text-lg'>
            No projects found that match the selected technologies. Try selecting different skills
            or check back later!
          </p>
        ) : (
